...
export default function OffersPlaceholderPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] bg-white rounded-2xl border border-slate-200/80 shadow-sm p-8 text-center">
      ...
      <h2 className="text-xl font-bold text-slate-800 mb-2 font-sans">العروض (قريباً)</h2>
      <p className="text-slate-500 max-w-md mx-auto font-sans">
        ستتمكن قريباً من مراجعة العروض المقدمة من المستقلين ومقارنتها واختيار العرض الأنسب لمشروعك.
      </p>
    </div>
  );
}
